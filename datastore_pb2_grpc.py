...
class DatastoreStub(object):
  ...
  def __init__(self, channel):
    ...
    self.replicator = channel.unary_stream(
        ...
        request_serializer=datastore__pb2.Request1.SerializeToString,
        response_deserializer=datastore__pb2.Response1.FromString,
        )
...
def add_DatastoreServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'replicator': grpc.unary_stream_rpc_method_handler(
          servicer.replicator,
          request_deserializer=datastore__pb2.Request1.FromString,
          response_serializer=datastore__pb2.Response1.SerializeToString,
      ),
  }
